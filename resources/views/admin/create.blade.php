        ...
        @auth
            ...
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">Dashboard | News</li>
                </ol>
                      ...
                      @include('layouts.partials.messages')
                        <form class="was-validated" action="{{ route('admin.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                              ...
                              <textarea class="form-control is-invalid" name="body" id="validationTextarea" placeholder="News Body" required></textarea>
                              <div class="invalid-feedback">
